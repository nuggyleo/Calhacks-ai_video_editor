...
const RegisterPage = () => {
  ...
  useEffect(() => {
    ...
    const animated = sessionStorage.getItem('registerAnimated');
    if (animated) {
      setHasAnimated(true);
    } else {
      sessionStorage.setItem('registerAnimated', 'true');
    }
  }, []);
      ...
      <div className={`mt-8 ${hasAnimated ? '' : 'animate-fade-in-form'}`}>
        ...
        <div className="mt-8 text-center">
          <p className="text-gray-500 text-sm">
            ...
            <Link href="/login" className="font-semibold bg-gradient-to-r from-blue-400 to-purple-400 bg-clip-text text-transparent hover:from-blue-300 hover:to-purple-300 transition-all">
              Sign in
            </Link>
          </p>
        </div>
